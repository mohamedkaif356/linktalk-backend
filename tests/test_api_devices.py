...
class TestDeviceRegistration:
    ...
    def test_register_device_existing_device_no_active_token(self, client, test_db):
        ...
        from app.db.models import Device, DeviceToken
        from app.api.v1.routes.devices import compute_device_fingerprint
        from datetime import datetime, timedelta
        
        # Compute the fingerprint that will be generated by the endpoint
        app_instance_id = "test-instance-existing"
        device_model = "Test Device"
        os_version = "1.0"
        device_fingerprint = compute_device_fingerprint(app_instance_id, device_model, os_version)
